...
If the user does not have permission to create repositories in the organisation, they should ask the admin team (contact: Chris Cooling) to perform the upload or create the repository and grant access.
...
4. Ask the user to register the new repository name with the Atomic Learning site and trigger a content sync manually. Inform them they will need site admin permissions, or they will need to contact Chris Cooling.
...
If GitHub upload steps fail for permission or organisation-policy reasons, tell the user to contact Chris Cooling.
